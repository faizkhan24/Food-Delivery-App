...
const RegisterScreen = ({
  ...
  return (
    <div
      className={`Modal ${showRegistrationModal ? "showModal" : "hideModal"}`}
    >
      <div className="login-box">
        <button className="register-back-btn" onClick={hideModal}>
          <img
            src="https://www.burgerking.in/static/media/left-arrow.e2f47880.svg"
            alt="Back"
          />
        </button>
        {loading && <Loading />}
        ...
        <div className="login-google-facebook">
          ...
          <div className="github-btn-container">
            <img className="github-img" src="../images/Github.png"></img>
            <button className="github-btn">Github</button>
          </div>
        </div>
        <div className="registration-field">
          <p style={{ cursor: "pointer" }} onClick={toggleForm}>
            Click Here To {isRegisterForm ? "Login" : "Register"}
          </p>
        </div>
